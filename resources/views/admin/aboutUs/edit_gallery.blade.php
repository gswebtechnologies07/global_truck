         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-12">
               ...
               <div class="bg-ytr col-8 m-auto">
                  <form method="post" action="{{route('update-gallery')}}" enctype="multipart/form-data" class="form-horizontal">
                     @csrf
                     @if(!empty($gallery->id))
                     <input type="hidden" name="_method" value="POST" />
                     <input type="hidden" name="id" value="{{old('id',$gallery->id)}}">
                     @else
                        ...
                        <div class="from_add">
                           <div class="col-lg-12 col-md-12 col-12">
                              <div class="new_photo_profile">
                                 <img id="output" src="{{URL::to('/')}}/public/images/about/{{$gallery->image}}" height="100" width="100">
